module MethodsPracticeHelpers
  ...
  def image_tag(source, alternate_text)
    ...
    %(<img class="img-thumbnail img-responsive" src="#{source}" alt="#{alternate_text}">)
  ...
  def bootstrap_alert(message, type='info')
    ...
    %(<div class="alert alert-#{type} alert-dismissible" type=#{type} role="alert">
  ...
  def current_date_and_time
    ...
    # current_hour = Time.now.strftime(%l)
